...
def set_layer(obj, layer_name):
  """ Move an object to a particular collection (layer) """
  # Ensure the collection exists
  if layer_name not in bpy.data.collections.keys():
    new_collection = bpy.data.collections.new(name=str(layer_name))
    bpy.context.scene.collection.children.link(new_collection)
  else:
    new_collection = bpy.data.collections[layer_name]
